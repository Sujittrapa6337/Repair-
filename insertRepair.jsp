...
<!-- Header -->
 ...
 <label>${message}</label>
    ...
    <div class="row">
      	<div >
      	<label for="Fullname">ชื่อ-นามสกุล</label></center>
      		<input type="text"  name="Fullname" placeholder="ชื่อ-นามสกุล">
      	<label for="Type">วันที่แจ้ง</label></center>
      		<input type="text" name="Type" placeholder="เช่น 2018-01-01 ">
   		<label for="NumberBuilding">หมายเลขอาคาร</label></center>
   			<input type="text"  name="NumberBuilding" placeholder="1.อาคารจุฬาภรณ์  2.อาคารเรียนรวม 60 ปี  3.อาคารเสาวรัจ นิตยวรรธนะ">
      	<label for="RoomID">หมายเลขห้อง</label></center>
      		<input type="text"  name="RoomID" placeholder="เช่น 1101">
      	<label for="Type">ประเภท</label></center>
      		<input type="text" name="Type" placeholder="โต๊ะ เก้าอี้ สายไฟ ">
      	<label for="Damage">ปัญหา</label></center>
      		<input type="text"  name="Damage" placeholder="ขาโต๊ะหัก ไฟไม่ออก"></input>
      	<label for="imagefile">ไฟล์รูป(ถ้ามี)</label>
      		<input type="file"  name="imageDamage"></input>
