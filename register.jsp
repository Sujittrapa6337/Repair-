...
<nav class="w3-sidebar w3-red w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block"> 
    ...
    <a href="${pageContext.request.contextPath}/register" class="w3-bar-item w3-button w3-hover-white" onclick="w3_close()">จัดการสมาชิก</a>
    <a href="#s" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">จัดการอาคารและห้องเรียน</a>
    <a href="#" class="w3-bar-item w3-button w3-hover-white" onclick="w3_close()">เพิ่มผู้ใช้</a>
    <a href="#" class="w3-bar-item w3-button w3-hover-white" onclick="w3_close()">จัดการรายการแจ้งซ่อม</a>
    <a href="#" class="w3-bar-item w3-button w3-hover-white" onclick="w3_close()">ออกจากระบบ</a> 
  </div>
</nav>
...
<!-- Header -->
 ...
 <div class="form-inline">
	...
	<div class="input-group mb-3">
        	...
        	<span class="input-group-text">ชื่อผู้ใช้-รหัสผ่าน</span>
     		</div>
	...
	<div class="input-group mb-3">
			...
			<input type="text" name="txtfullname" placeholder="ชื่อ">  
	</div>
	<div class="input-group mb-3">
			<div class="input-group-prepend">
