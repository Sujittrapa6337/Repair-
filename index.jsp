...
<nav class="w3-sidebar w3-red w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="${pageContext.request.contextPath}/loginAdmin" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">เข้าสู่ระบบแอดมิน</a>  
...
<div class="mySlides fade">
  ...
  <img src="https://bit.ly/2zT4r94" style="width:70%">
  <div class="text">Caption Text</div>
</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 3</div>
  <img src="https://bit.ly/2OFUHak" style="width:70%">
  <div class="text">Caption Two</div>
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 3</div>
  <img src="https://bit.ly/2QwmJ5s" style="width:70%">
