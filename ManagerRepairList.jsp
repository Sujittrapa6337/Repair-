...
<nav class="w3-sidebar w3-red w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block"> 
    ...
    <a href="${pageContext.request.contextPath}/login" 		onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">เข้าสู่ระบบบุคลกร</a>
    <a href="${pageContext.request.contextPath}/AdminLogin" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">เข้าสู่ระบบสำหรับผู้ดูแลระบบ</a>  
...
<!-- Header -->
 ...
 <table id="customers">
	<tr>
		...
		<th><center><h5>UserID</h5></center></th>
		<th><center><h5>Fullname</h5></center></th>
		<th><center><h5>Position</h5></center></th>
		<th><center><h5>Email</h5></center></th>
		<th><center><h5>password</h5></center></th>
		<th><center><h5>Telephone</h5></center></th>
		<th><center><h5>MajorID</h5></center></th>
	</tr>
