...
<%ListUser u = (ListUser) session.getAttribute("user");%>
...
<!-- Header -->
  	<div class="w3-container" style="margin-top:50px" id="showcase">
    	<h1 class="w3-xxxlarge"><b>แก้ไขข้อมูลส่วนตัว</b></h1>
    	<h1 class="w3-xlarge w3-text-red"><b><%= username %></b></h1>
    	<hr>
 	</div>
  <label>${message}</label>
 	<div class="container">
  <form:form action="${pageContext.request.contextPath}/EditProfile" modelAttribute="profile"  method="post">
    <div class="row">
      <div class="col-25">
        <label for="UserID">ชื่อผู้ใช้</label>
      </div>
      <div class="col-75">
        <input type="text" id="UserID" name="UserID" value="<%= u.getUserID() %>" readonly>
      </div>
    </div>
    <div class="row">
      <div class="col-25">
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="major" name="major" value="<%= u.getMajor() %>">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="Telephone" name="Telephone" value="<%= u.getTelephone() %>"></input>
      </div>
    </div>
    <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="text" id="Email" name="Eamil" value="<%= u.getEmail() %>"></input>
      </div>
    </div><p>
    <div class="row">
